...
L.HeatLayer = (L.Layer ? L.Layer : L.Class).extend({
    ...
    _redraw: function() {
        var t, i, a, s, e, n, h, o, r, _ = [],
            ...
            v = p.x % g,
            w = p.y % g;
        for (t = 0, i = this._latlngs.length; i > t; t++) if (m.contains(this._latlngs[t])) {
        ...
        for (t = 0, i = f.length; i > t; t++) if (f[t]) for (h = 0, o = f[t].length; o > h; h++) s = f[t][h], s && _.push([Math.round(s[0]), Math.round(s[1]), Math.min(s[2], 1)]);
